...
thanks: "This paper extends the paper \"Legislature Size and Welfare,\" (<https://osf.io/preprints/socarxiv/8r97e/>) co-authored with Gabriel Cepaluni (UNESP - Brazil). I thank Gabriel Cepaluni for kindly agree to me use our previous results in my Job Market Paper. All the errors and inconsistencies here are my entire responsibility. The materials required to replicate this study are available at <https://github.com/umbertomig/legislators-bargaining-costs>."
...
# Needed packages
pkgs <- c('foreign', 'readxl', 'remotes','stargazer', 
...
## Load dataset
load('../datasets/dataNumLegPGProv.RData')

## Load auxiliary functions
source('../datasets/auxFunctions.R')
```
